...
var lyr_ChangeinLSTC_1 = new ol.layer.Image({
        opacity: 1,
        
    title: 'Change in LST (°C)<br />\
    <img src="styles/legend/ChangeinLSTC_1_0.png" /> -8.1<br />\
    <img src="styles/legend/ChangeinLSTC_1_1.png" /> -4.0<br />\
    <img src="styles/legend/ChangeinLSTC_1_2.png" /> -2.0<br />\
    <img src="styles/legend/ChangeinLSTC_1_3.png" /> 0.0<br />\
    <img src="styles/legend/ChangeinLSTC_1_4.png" /> 2.0<br />\
    <img src="styles/legend/ChangeinLSTC_1_5.png" /> 4.0<br />\
    <img src="styles/legend/ChangeinLSTC_1_6.png" /> 8.0<br />\
    <img src="styles/legend/ChangeinLSTC_1_7.png" /> 12.0<br />\
    <img src="styles/legend/ChangeinLSTC_1_8.png" /> 17.7<br />' ,
        
        
        source: new ol.source.ImageStatic({
            url: "./layers/ChangeinLSTC_1.png",
            attributions: ' ',
...
lyr_GoogleSatellite_0.setVisible(true);lyr_ChangeinLSTC_1.setVisible(true);lyr_TOPPrecincts_2.setVisible(true);lyr_Roads_3.setVisible(true);
var layersList = [lyr_GoogleSatellite_0,lyr_ChangeinLSTC_1,lyr_TOPPrecincts_2,lyr_Roads_3];
